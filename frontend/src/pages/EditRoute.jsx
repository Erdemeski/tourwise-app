import { Alert, Button, Card, Checkbox, FileInput, Label, Select, Spinner, TextInput } from 'flowbite-react';
    ...
    if (loadingRoute) {
        return (
            <div className='flex p-5 justify-center pb-96 items-center md:items-baseline min-h-screen'>
                <Spinner size='xl' />
                <p className='text-center text-gray-500 m-2'>Loading route...</p>
            </div>
        );
    }
        ...
        <div className='relative isolate bg-gray-50 dark:bg-[rgb(22,26,29)]'>
            <div className='p-3 max-w-4xl mx-auto min-h-screen'>
                ...
                <form className='flex flex-col gap-6' onSubmit={handleSubmit}>
                    ...
                    <Card className='p-4 shadow-lg'>
                        <h3 className='text-xl font-semibold mb-4'>Waypoints</h3>
                    ...
                    <Button className='mb-3' type='submit' gradientDuoTone='purpleToPink'>Save changes</Button>
